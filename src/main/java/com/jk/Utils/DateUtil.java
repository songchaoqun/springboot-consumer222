...
public class DateUtil {
	...
	* @Description:��ʽ������
	*/  
	public static String formatDate(Date date,String format){ //Date�͸�ʽ���ַ���
		String result="";
	...
	public static String formatString(String str)throws Exception//SqlDateͨ���ַ������и�ʽ��
	{
		if(str==null){
			return null;
		}
	...
	public static String getCurrentDateStr()throws Exception{ //��ʽ����ǰ����
		Date date=new Date();
